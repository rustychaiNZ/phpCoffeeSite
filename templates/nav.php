<ul class="nav nav-pills">
	...
	<li class="nav-item">  <a class="nav-link <?php if($title === 'Contact'): ?>active<?php endif; ?>" href="contact.php">Contact</a> </li>
	<li class="nav-item">  <a class="nav-link <?php if($title === 'Types'): ?>active<?php endif; ?>" href="typesOfCoffe.php">Types of Coffe</a> </li>
</ul>
